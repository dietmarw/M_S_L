  ...
  package Examples "Test examples"
    ...
    package AsynchronousInductionMachines
      ...
      model AIMC_DOL
        ...
        BasicMachines.AsynchronousInductionMachines.AIM_SquirrelCage aimc(
          p=aimcData.p,
        ...
        Modelica_Mechanics_Rotational.Sources.QuadraticSpeedDependentTorque
          ...
          useSupport=false) annotation (Placement(transformation(extent={{90,-50},
                  {70,-30}}, rotation=0)));
        Utilities.TerminalBox terminalBox(terminalConnection="D") annotation (
      ...
      model AIMC_YD
        ...
        Modelica_Electrical_MultiPhase.Ideal.IdealClosingSwitch idealCloser(
          ...
          Goff=fill(1e-5, m)) annotation (Placement(transformation(
              ...
              extent={{-10,10},{10,-10}},
              rotation=270)));
        Utilities.SwitchYD switchYD(m=m) annotation (Placement(transformation(
      ...
      model AIMC_Transformer
        ...
        Modelica_Electrical_MultiPhase.Ideal.IdealClosingSwitch idealCloser(
          ...
          Goff=fill(1e-5, m)) annotation (Placement(transformation(
              ...
              extent={{-10,10},{10,-10}},
              rotation=270)));
        BasicMachines.Transformers.Yy.Yy00 transformer(
          n=transformerData.n,
          ...
          T1Ref=293.15,
          alpha20_1(displayUnit="1/K") = Thermal.Constants.alpha20Zero,
          T2Ref=293.15,
          alpha20_2(displayUnit="1/K") = Thermal.Constants.alpha20Zero,
        ...
        Modelica_Electrical_Analog.Basic.Ground ground2 annotation (Placement(
              ...
              extent={{-10,-10},{10,10}},
              rotation=270)));
        parameter Utilities.TransformerData transformerData(
          f=fNominal,
          V1=VNominal,
...
Default machine parameters of model <i>AIM_SquirrelCage</i> are used.
      ...
      model AIMS_Start "Test example: AsynchronousInductionMachineSlipRing"
        ...
        parameter Modelica_SIunits.Inertia JLoad=0.29
          "Load's moment of inertia";
        BasicMachines.AsynchronousInductionMachines.AIM_SlipRing aims(
          p=aimsData.p,
          Jr=aimsData.Jr,
          Js=aimsData.Js,
          phiMechanical(fixed=true),
        ...
        Utilities.TerminalBox terminalBox(terminalConnection="D") annotation (
            Placement(transformation(extent={{-20,-30},{0,-10}}, rotation=0)));
        Utilities.SwitchedRheostat switchedRheostat(
          RStart=Rstart,
          tStart=tStart2,
          m=m)
...
Default machine parameters of model <i>AIM_SlipRing</i> are used.
      ...
      model AIMC_Inverter
        ...
        Utilities.VfController vfController(
          final m=m,
          VNominal=VNominal,
        ...
        Modelica_Mechanics_Rotational.Sources.TorqueStep loadTorqueStep(
          ...
          offsetTorque=0) annotation (Placement(transformation(extent={{90,-50},
                  {70,-30}}, rotation=0)));
        Utilities.TerminalBox terminalBox(terminalConnection="Y") annotation (
            Placement(transformation(extent={{-20,-30},{0,-10}}, rotation=0)));
        parameter Utilities.ParameterRecords.AIM_SquirrelCageData aimcData
          annotation (Placement(transformation(extent={{-20,-80},{0,-60}})));
      initial equation
...
Default machine parameters of model <i>AIM_SquirrelCage</i> are used.
      ...
      model AIMC_Steinmetz
        ...
        Modelica_Mechanics_Rotational.Sources.QuadraticSpeedDependentTorque
          ...
          useSupport=false) annotation (Placement(transformation(extent={{90,-50},
                  {70,-30}}, rotation=0)));
        Utilities.TerminalBox TerminalBox1(terminalConnection="D") annotation (
            Placement(transformation(extent={{-20,-30},{0,-10}}, rotation=0)));
...
Default machine parameters of model <i>AIM_SquirrelCage</i> are used.
      ...
      public
        output Modelica_SIunits.Power Pmech=powerSensor.power
          "Mechanical output";
        ...
        Sensors.ElectricalPowerSensor electricalPowerSensor annotation (
            Placement(transformation(
              extent={{-10,-10},{10,10}},
              rotation=270,
              origin={-30,40})));
        ...
        parameter Utilities.ParameterRecords.AIM_SquirrelCageData aimcData(
          ...
          Jr=0.12,
          Rs=0.56,
          alpha20s(displayUnit="1/K")=Thermal.Constants.alpha20Copper,
          ...
          Rr=0.42,
          alpha20r(displayUnit="1/K")=Thermal.Constants.alpha20Aluminium)
...
This package contains test examples of asynchronous induction machines.
    ...
    package SynchronousInductionMachines
      ...
      model SMR_Inverter
        ...
        parameter Modelica_SIunits.Inertia JLoad=0.29
          "Load's moment of inertia";
        BasicMachines.SynchronousInductionMachines.SM_ReluctanceRotor smr(
          p=smrData.p,
        ...
        Sensors.CurrentQuasiRMSSensor currentQuasiRMSSensor annotation (
            Placement(transformation(
              ...
              extent={{-10,10},{10,-10}},
              rotation=270)));
        Sensors.RotorDisplacementAngle rotorDisplacementAngle(p=smr.p)
          annotation (Placement(transformation(
              origin={20,-40},
              extent={{10,-10},{-10,10}},
              rotation=90)));
...
Default machine parameters of model <i>SM_ReluctanceRotor</i> are used.
      ...
      model SMPM_Inverter
        ...
        parameter Modelica_SIunits.Inertia JLoad=0.29
          "Load's moment of inertia";
        BasicMachines.SynchronousInductionMachines.SM_PermanentMagnet smpm(
          p=smpmData.p,
        ...
        Sensors.CurrentQuasiRMSSensor currentQuasiRMSSensor annotation (
            Placement(transformation(
              ...
              extent={{-10,10},{10,-10}},
              rotation=270)));
        Sensors.RotorDisplacementAngle rotorDisplacementAngle(p=smpm.p)
          annotation (Placement(transformation(
              origin={20,-40},
              extent={{-10,10},{10,-10}},
              rotation=270)));
      ...
      model SMPM_VoltageSource
        ...
        Modelica_Electrical_MultiPhase.Sensors.CurrentSensor currentSensor(m=m)
          annotation (Placement(transformation(
              ...
              rotation=270,
              origin={-10,0})));
        Utilities.VoltageController voltageController(
          p=smpm.p,
          Ld=smpm.Lssigma + smpm.Lmd,
          Lq=smpm.Lssigma + smpm.Lmq,
          Rs=Thermal.convertResistance(
                    smpm.Rs,
                    smpm.TsRef,
                    smpm.alpha20s,
                    smpm.TsOperational),
...
Default machine parameters of model <a href=\"modelica://Modelica.Electrical.Machines.BasicMachines.SynchronousInductionMachines.SM_PermanentMagnet\">SM_PermanentMagnet</a> are used.
      ...
      model SMEE_Generator
        ...
        BasicMachines.SynchronousInductionMachines.SM_ElectricalExcited smee(
          ...
          TeOperational=293.15) annotation (Placement(transformation(extent={{-20,
                  -50},{0,-30}}, rotation=0)));
        Sensors.RotorDisplacementAngle rotorDisplacementAngle(p=smee.p)
          annotation (Placement(transformation(
              origin={20,-40},
              extent={{-10,10},{10,-10}},
              rotation=270)));
        ...
        Sensors.MechanicalPowerSensor mechanicalPowerSensor annotation (
        ...
        parameter Utilities.SynchronousMachineData smeeData(
          ...
          alpha20s(displayUnit="1/K") = Thermal.Constants.alpha20Zero,
          alpha20r(displayUnit="1/K") = Thermal.Constants.alpha20Zero,
          alpha20e(displayUnit="1/K") = Thermal.Constants.alpha20Zero,
...
Default machine parameters of model <i>SM_ElectricalExcited</i> are used.
      ...
      model SMEE_LoadDump
        ...
        Sensors.VoltageQuasiRMSSensor voltageQuasiRMSSensor(ToSpacePhasor1(y(
...
This package contains test examples of synchronous induction machines.
    ...
    package DCMachines "Test examples of DC machines"
      ...
      model DCPM_Start
        ...
        parameter Modelica_SIunits.Inertia JLoad=0.15
          "Load's moment of inertia";
        BasicMachines.DCMachines.DC_PermanentMagnet dcpm(
...
Default machine parameters of model <i>DC_PermanentMagnet</i> are used.
      ...
      model DCEE_Start
        ...
        parameter Modelica_SIunits.Inertia JLoad=0.15
          "Load's moment of inertia";
        BasicMachines.DCMachines.DC_ElectricalExcited dcee(
...
Default machine parameters of model <i>DC_ElectricalExcited</i> are used.
      ...
      model DCSE_Start
        ...
        parameter Modelica_SIunits.Inertia JLoad=0.15
          "Load's moment of inertia";
        BasicMachines.DCMachines.DC_SeriesExcited dcse(
      ...
      model DCPM_Temperature
        ...
        Modelica_Mechanics_Rotational.Sources.TorqueStep loadTorque(
          ...
          startTime=0.1) annotation (Placement(transformation(extent={{60,-10},
                  {40,10}}, rotation=0)));
        Thermal.DCMachines.ThermalAmbientDCPM thermalAmbientDCPM(
        ...
        Modelica_Blocks.Sources.Constant const(k=293.15)
          annotation (Placement(transformation(extent={{40,-60},{20,-40}})));
        parameter Utilities.ParameterRecords.DcPermanentMagnetData dcpmData(
          alpha20a(displayUnit="1/K")=Thermal.Constants.alpha20Copper,
          TaNominal=353.15,
          TaRef=353.15)
          annotation (Placement(transformation(extent={{-20,-80},{0,-60}})));
...
(with the same armature resistance as the unmodified machine).
      ...
      model DCPM_Cooling "Test example: Cooling of a DCPM motor"
        ...
        parameter Modelica_SIunits.Temperature TAmbient=293.15
          "Ambient temperature";
        parameter Modelica_SIunits.HeatCapacity Ca=20
      ...
      protected
        Interfaces.DCMachines.ThermalPortDCPM thermalPort
...
<li>Nominal armature temperature is set to 80 degC.</li>
      ...
      model DCPM_QuasiStationary
        ...
        parameter Modelica_SIunits.Inertia JLoad=0.15
          "Load's moment of inertia";
        BasicMachines.DCMachines.DC_PermanentMagnet dcpm1(
          VaNominal=dcpmData.VaNominal,
          IaNominal=dcpmData.IaNominal,
          wNominal=dcpmData.wNominal,
          TaNominal=dcpmData.TaNominal,
        ...
        BasicMachines.QuasiStationaryDCMachines.DC_PermanentMagnet dcpm2(
          VaNominal=dcpmData.VaNominal,
          IaNominal=dcpmData.IaNominal,
          wNominal=dcpmData.wNominal,
          TaNominal=dcpmData.TaNominal,
...
This package contains test examples of DC machines.
    ...
    package Transformers "Test examples of transformers"
      ...
      model TransformerTestbench "Transformer Testbench"
        ...
        Sensors.ElectricalPowerSensor electricalPowerSensorS annotation (
            Placement(transformation(extent={{-90,0},{-70,20}}, rotation=0)));
        Sensors.CurrentQuasiRMSSensor currentQuasiRMSSensorS annotation (
            Placement(transformation(extent={{-60,20},{-40,0}}, rotation=0)));
        Sensors.VoltageQuasiRMSSensor voltageQuasiRMSSensorS annotation (
            Placement(transformation(
              origin={-50,-30},
              extent={{-10,10},{10,-10}},
              rotation=180)));
        ...
        Sensors.VoltageQuasiRMSSensor voltageRMSSensorL annotation (Placement(
              transformation(
              origin={50,-30},
              extent={{-10,-10},{10,10}},
              rotation=0)));
        Modelica_Electrical_MultiPhase.Basic.Delta deltaL annotation (Placement(
              ...
              extent={{-10,10},{10,-10}},
              rotation=180)));
        Sensors.CurrentQuasiRMSSensor currentQuasiRMSSensorL annotation (
            Placement(transformation(extent={{40,20},{60,0}}, rotation=0)));
        Sensors.ElectricalPowerSensor electricalPowerSensorL annotation (
...
<li>Dz ... Load current in three primary phases.</li>
      ...
      model Rectifier6pulse "6-pulse rectifier with 1 transformer"
        ...
        parameter Utilities.TransformerData transformerData1(
          C1=Modelica_Utilities.Strings.substring(
...
neglecting initial transient.
      ...
      model Rectifier12pulse "12-pulse rectifier with 2 transformers"
        ...
        parameter Utilities.TransformerData transformerData2(
          C1=Modelica_Utilities.Strings.substring(
