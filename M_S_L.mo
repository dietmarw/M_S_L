within ;
package M_S_L "Modelica Standard Library - Demo version"
...
uses(
Modelica_Blocks_Examples(version="3.2.2"),
Modelica_Blocks_Interfaces(version="3.2.2"),
Modelica_Blocks(version="3.2.2"),
Modelica_ComplexBlocks_Examples(version="3.2.2"),
