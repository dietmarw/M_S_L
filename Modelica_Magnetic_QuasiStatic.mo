within ;
package Modelica_Magnetic_QuasiStatic "Quasi static magnetic package"
    ...
    package Examples "Examples"
      ...
      package Components
        ...
        model MultiPhaseInductance "Multi phase inductance"
          ...
          Modelica_Electrical_QuasiStationary.MultiPhase.Basic.Inductor
            inductor_e(m=m, L=fill(L, m)) annotation (Placement(transformation(
                ...
                rotation=270,
                origin={0,70})));
          Modelica_Magnetic_QuasiStatic.FundamentalWave.Components.MultiPhaseElectroMagneticConverter
            converter_m(m=m, effectiveTurns=effectiveTurns)
            annotation (Placement(transformation(extent={{0,-40},{20,-20}})));
          Modelica_Magnetic_QuasiStatic.FundamentalWave.Components.Reluctance reluctance_m(R_m(d=R_m,
                q=R_m)) annotation (Placement(transformation(
                extent={{-10,-10},{10,10}},
                rotation=270,
                origin={60,-30})));
          Modelica_Magnetic_QuasiStatic.FundamentalWave.Components.Ground groundM_m
        ...
        model EddyCurrentLosses
          ...
          Modelica_Magnetic_QuasiStatic.FundamentalWave.Components.EddyCurrent loss_m(G=m*N^2*
                Gc/2) annotation (Placement(transformation(
                extent={{-10,-10},{10,10}},
                rotation=0,
                origin={60,-20})));
          Modelica_Magnetic_QuasiStatic.FundamentalWave.Components.Reluctance reluctance_e(R_m(d=R_m,
                q=R_m)) annotation (Placement(transformation(
                extent={{-10,-10},{10,10}},
                rotation=270,
                origin={80,60})));
          Modelica_Magnetic_QuasiStatic.FundamentalWave.Components.Reluctance reluctance_m(R_m(d=R_m,
                ...
                rotation=270,
                origin={80,-30})));
          Modelica_Magnetic_QuasiStatic.FundamentalWave.Components.Ground mground_e
            annotation (Placement(transformation(extent={{30,0},{50,20}})));
          Modelica_Magnetic_QuasiStatic.FundamentalWave.Components.Ground mground_m
      ...
      package BasicMachines "Examples of basic machines"
        ...
        package InductionMachines "Induction machine examples"
          ...
          model IMC_DOL
            ...
            parameter Modelica_SIunits.Frequency fNominal=50
              "Nominal frequency";
            parameter Modelica_SIunits.Time tOn=0.1 "Start time of machine";
            parameter Modelica_SIunits.Torque T_Load=161.4
              "Nominal load torque";
...
")}),           experiment);
          ...
          model IMC_Inverter
            ...
            parameter Modelica_SIunits.Time tStep=1.2
              "Time of load torque step";
...
")}));
        ...
        package SynchronousMachines "Synchronous machine examples"
          ...
          model SMPM_Mains
            ...
            parameter Modelica_SIunits.Torque T_Load=181.4
              "Nominal load torque";
            parameter Modelica_SIunits.Time tStep=0.5
              "Time of load torque step";
            parameter Modelica_SIunits.Inertia J_Load=0.29 "Load inertia";
            Modelica_Electrical_QuasiStationary.MultiPhase.Sources.VoltageSource
              voltageSourceQS(
          ...
          model SMPM_CurrentSource
            ...
            Modelica_Electrical_MultiPhase.Sensors.CurrentQuasiRMSSensor
              currentQuasiRMSSensor annotation (Placement(transformation(
                  ...
                  extent={{-10,-10},{10,10}},
                  rotation=270)));
            Modelica_Magnetic_QuasiStatic.FundamentalWave.BasicMachines.SynchronousMachines.SM_PermanentMagnet
              smpmQS(
              p=smpmData.p,
              fsNominal=smpmData.fsNominal,
              Rs=smpmData.Rs,
            ...
            Modelica_Electrical_QuasiStationary.SinglePhase.Basic.Ground
              groundMQS annotation (Placement(transformation(
                  ...
                  rotation=270,
                  origin={-50,44})));
            Modelica_Magnetic_QuasiStatic.FundamentalWave.Utilities.MultiTerminalBox
              terminalBoxQS(terminalConnection="Y", m=m) annotation (Placement(
                  transformation(extent={{-10,44},{10,64}}, rotation=0)));
            Modelica_Magnetic_QuasiStatic.FundamentalWave.Utilities.CurrentController
              currentController1(m=m, p=smpmQS.p) annotation (Placement(
                  transformation(extent={{-50,74},{-30,94}})));
...
Default machine parameters of model <a href=\"modelica://Modelica.Electrical.Machines.BasicMachines.SynchronousInductionMachines.SM_PermanentMagnet\">SM_PermanentMagnet</a> are used.
          ...
          model SMEE_Generator
            ...
            parameter Modelica_SIunits.Voltage VsNominal=100
              "Nominal RMS voltage per phase";
            parameter Modelica_SIunits.Frequency fsNominal=50
              "Nominal frequency";
            ...
            parameter Modelica_SIunits.Current Ie0=10
            ...
            parameter
              Modelica_Electrical_Machines.Utilities.SynchronousMachineData
              smeeData(
              SNominal=30e3,
              VsNominal=100,
              fsNominal=50,
    ...
    package BasicMachines "Basic quasi static machine models"
      ...
      package InductionMachines "Quasi static induction machines"
        ...
        model IM_SquirrelCage "Induction machine with squirrel cage"
          ...
          extends FundamentalWave.Interfaces.PartialBasicMachine(
            Rs(start=0.03),
...
Magnetic.FundamentalWave.BasicMachines.SM_ReluctanceRotor</a>,
      ...
      package Components "Components for quasi static machine models"
        ...
        model SymmetricMultiPhaseWinding
          ...
          Modelica_SIunits.ReactivePower Q[m] = {Modelica_ComplexMath.imag(v[k]*Modelica_ComplexMath.conj(i[k])) for k in 1:m}
            "Reactive power";
          Modelica_SIunits.ReactivePower Q_total = sum(Q)
          ...
          Modelica_Magnetic_QuasiStatic.FundamentalWave.Components.EddyCurrent core(final
            ...
            "Core loss model (currently eddy currents only)" annotation (
              Placement(transformation(
                ...
                rotation=0,
                origin={50,-40})));
          Modelica_Magnetic_QuasiStatic.FundamentalWave.Components.Reluctance strayReluctance(final R_m(
...
Magnetic.FundamentalWave.BasicMachines.Components.RotorSaliencyAirGap</a>
        ...
        model SymmetricMultiPhaseCageWinding "Symmetrical rotor cage"
          import Modelica_Constants.pi;
          extends
            Modelica_Magnetic_QuasiStatic.FundamentalWave.Interfaces.PartialTwoPortExtended;
          parameter Integer m=3 "Number of phases";
          parameter Boolean useHeatPort=false
            "Enable / disable (=fixed temperatures) thermal port"
            annotation (Evaluate=true);
...
<a href=\"modelica://Modelica.Magnetic.QuasiStatic.FundamentalWave.Losses.PermanentMagnetLosses\">PermanentMagnetLosses</a>. 
    ...
    package Losses "Loss models"
      ...
      model StrayLoad
        ...
        import
          Modelica_Electrical_QuasiStationary.MultiPhase.Functions.quasiRMS;
...
The partial two port model consists of a positive and a negative magnetic port. The reference angles of the two ports are set equal and connected through <code>Connections.branch</code>.
      ...
      partial model PartialTwoPortExtended
        ...
        extends
          Modelica_Magnetic_QuasiStatic.FundamentalWave.Interfaces.PartialTwoPort;
