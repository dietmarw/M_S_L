  ...
  package Examples "Multiphase test examples"
    ...
    model TransformerYY "Test example with multiphase components"
      ...
      Basic.Resistor loadR(m=m, R=fill(RL, m)) annotation (Placement(
            transformation(extent={{70,10},{90,30}}, rotation=0)));
...
neglecting initial transient.
    ...
    model TestSensors
      ...
      parameter Modelica_SIunits.Voltage VRMS=100
...
<a href=\"modelica://Modelica.Electrical.MultiPhase.Basic.MultiDelta\">MultiDelta</a>
    ...
    model MultiStar
      ...
      final parameter Integer mSystems=
          Functions.numberOfSymmetricBaseSystems(
...
Contains m inductors (Modelica.Electrical.Analog.Basic.Inductor)
    ...
    model SaturatingInductor "Simple model of inductors with saturation"
      ...
      parameter Modelica_SIunits.Inductance Lzer[m](start={2*Lnom[j] for j in 1
            :m}) "Inductance near current=0";
      parameter Modelica_SIunits.Inductance Linf[m](start={Lnom[j]/2 for j in 1
            :m}) "Inductance at large currents";
      Modelica_Electrical_Analog.Basic.SaturatingInductor saturatingInductor[m](
        final Inom=Inom,
        final Lnom=Lnom,
        final Lzer=Lzer,
...
Each element of the array of saturatingInductors is only dependent on the current flowing through this element.
    ...
    model MutualInductor "Linear mutual inductor"
      ...
      parameter Integer m=3 "Number of phases";
      parameter Modelica_SIunits.Inductance L[m, m] "Mutual inductance matrix";
    initial equation
      if abs(Modelica_Math.Matrices.det(L)) < epsilon then
        Modelica_Utilities.Streams.print(
...
<pre>
  v = Lzero*sum(der(i)) = Lzero*der(sum(i))
    ...
    model Transformer "Multiphase Transformer"
      ...
      parameter Modelica_SIunits.Inductance M[m](start=fill(1, m))
        "Coupling inductance";
      Modelica_Electrical_Analog.Basic.Transformer transformer[m](
        final L1=L1,
        final L2=L2,
    ...
    model VariableResistor
      ...
      Modelica_Blocks.Interfaces.RealInput R[m](each unit="Ohm") annotation (
          Placement(transformation(
            ...
            extent={{-10,-10},{10,10}},
            rotation=270)));
      Modelica_Electrical_Analog.Basic.VariableResistor variableResistor[m](
        final T_ref=T_ref,
        final alpha=alpha,
        each final useHeatPort=useHeatPort,
        final T=T) annotation (Placement(transformation(extent={{-10,-10},{10,
    ...
    model VariableConductor
      ...
      Modelica_Blocks.Interfaces.RealInput G[m](each unit="S") annotation (
          Placement(transformation(
            ...
            extent={{-10,-10},{10,10}},
            rotation=270)));
      Modelica_Electrical_Analog.Basic.VariableConductor variableConductor[m](
        final T_ref=T_ref,
        final alpha=alpha,
        each final useHeatPort=useHeatPort,
        final T=T) annotation (Placement(transformation(extent={{-10,-10},{10,
    ...
    model VariableCapacitor
      ...
      Modelica_Blocks.Interfaces.RealInput C[m](each unit="F") annotation (
          Placement(transformation(
            ...
            extent={{-10,-10},{10,10}},
            rotation=270)));
      Modelica_Electrical_Analog.Basic.VariableCapacitor variableCapacitor[m](
    ...
    model VariableInductor
      ...
      Modelica_Blocks.Interfaces.RealInput L[m](each unit="H") annotation (
          Placement(transformation(
            ...
            extent={{-10,-10},{10,10}},
            rotation=270)));
      Modelica_Electrical_Analog.Basic.VariableInductor variableInductor[m](
...
Contains m ideal diodes (Modelica.Electrical.Analog.Ideal.IdealDiode).
    ...
    model IdealThyristor "Multiphase ideal thyristor"
      ...
      Modelica_Blocks.Interfaces.BooleanInput fire[m] annotation (Placement(
            ...
            extent={{-20,-20},{20,20}},
            rotation=270)));
      Modelica_Electrical_Analog.Ideal.IdealThyristor idealThyristor[m](
        final Ron=Ron,
        final Goff=Goff,
        final Vknee=Vknee,
        each final useHeatPort=useHeatPort) annotation (Placement(
...
Contains m ideal thyristors (Modelica.Electrical.Analog.Ideal.IdealThyristor).
    ...
    model IdealGTOThyristor "Multiphase ideal GTO thyristor"
      ...
      Modelica_Blocks.Interfaces.BooleanInput fire[m] annotation (Placement(
            ...
            extent={{-20,-20},{20,20}},
            rotation=270)));
      Modelica_Electrical_Analog.Ideal.IdealGTOThyristor idealGTOThyristor[m](
        final Ron=Ron,
        final Goff=Goff,
        final Vknee=Vknee,
        each final useHeatPort=useHeatPort) annotation (Placement(
...
Contains m ideal intermediate switches (Modelica.Electrical.Analog.Ideal.IdealIntermediateSwitch).
    ...
    model IdealTransformer "Multiphase ideal transformer"
      ...
      parameter Modelica_SIunits.Inductance Lm1[m](start=fill(1, m))
        "Magnetization inductances w.r.t. primary side";
      Modelica_Electrical_Analog.Ideal.IdealTransformer idealTransformer[m](
        final n=n,
    ...
    model IdealOpeningSwitch "Multiphase ideal opener"
      ...
      Modelica_Blocks.Interfaces.BooleanInput control[m]
        "true => switch open, false => p--n connected" annotation (Placement(
            ...
            extent={{-20,-20},{20,20}},
            rotation=270)));
      Modelica_Electrical_Analog.Ideal.IdealOpeningSwitch idealOpeningSwitch[m](
        final Ron=Ron,
        final Goff=Goff,
        each final useHeatPort=useHeatPort) annotation (Placement(
            transformation(extent={{-10,-10},{10,10}}, rotation=0)));
    ...
    model IdealClosingSwitch "Multiphase ideal closer"
      ...
      Modelica_Blocks.Interfaces.BooleanInput control[m]
        "true => p--n connected, false => switch open" annotation (Placement(
            ...
            extent={{-20,-20},{20,20}},
            rotation=270)));
      Modelica_Electrical_Analog.Ideal.IdealClosingSwitch idealClosingSwitch[m](
        final Ron=Ron,
        final Goff=Goff,
        each final useHeatPort=useHeatPort) annotation (Placement(
            transformation(extent={{-10,-10},{10,10}}, rotation=0)));
...
Contains m ideal closing switches (Modelica.Electrical.Analog.Ideal.IdealClosingSwitch).
    ...
    model OpenerWithArc "Multiphase opener with arc"
      ...
      parameter Modelica_SIunits.Conductance Goff[m](final min=zeros(m), start=
            fill(1.E-5, m)) "Opened switch conductance";
      parameter Modelica_SIunits.Voltage V0[m](start=fill(30, m))
        "Initial arc voltage";
      parameter Modelica_SIunits.VoltageSlope dVdt[m](start=fill(10E3, m))
        "Arc voltage slope";
      ...
      Modelica_Blocks.Interfaces.BooleanInput control[m]
        "true => switch open, false => p--n connected" annotation (Placement(
            ...
            extent={{-20,-20},{20,20}},
            rotation=270)));
      Modelica_Electrical_Analog.Ideal.OpenerWithArc openerWithArc[m](
        final Ron=Ron,
        final Goff=Goff,
        final V0=V0,
        final dVdt=dVdt,
    ...
    model CloserWithArc "Multiphase closer with arc"
      ...
      Modelica_Blocks.Interfaces.BooleanInput control[m]
        "true => switch open, false => p--n connected" annotation (Placement(
            ...
            extent={{-20,-20},{20,20}},
            rotation=270)));
      Modelica_Electrical_Analog.Ideal.CloserWithArc closerWithArc[m](
        final Ron=Ron,
        final Goff=Goff,
        final V0=V0,
        final dVdt=dVdt,
...
<pre>
 y = sqrt(sum(u[k]^2 for k in 1:m)/m)
    ...
    function activePower "Calculate active power of voltage and current input"
      extends Modelica_Icons.Function;
      input Modelica_SIunits.Voltage v[:] "phase voltages";
      input Modelica_SIunits.Current i[size(v, 1)] "phase currents";
...
In quasistaionary operation, instantaneous power equals active power;
    ...
    function symmetricOrientation
      ...
      output Modelica_SIunits.Angle orientation[m]
...
<a href=\"modelica://Modelica.Magnetic.FundamentalWave.UsersGuide.MultiPhase\">User's guide on multi phase winding</a>,
    ...
    function symmetricOrientationMatrix
      ...
      import Modelica_Constants.pi;
      input Integer m "Number of phases";
      output Modelica_SIunits.Angle orientation[m, m]
...
[<a href=\"modelica://Modelica.Electrical.Machines.UsersGuide.References\">Vaske1963</a>.
    ...
    algorithm
      // Init transformation matrix with zeros
      transformation := Modelica_ComplexMath.fromPolar(fill(
            numberOfSymmetricBaseSystems(m)/m,
            m,
            m), symmetricOrientationMatrix(m));
  ...
  package Sensors "Multiphase potential, voltage and current Sensors"
    ...
    equation
      ...
      annotation (Icon(graphics={Line(points={{70,0},{100,0}}, color={0,0,127}),
              Line(points={{-70,0},{-90,0}}, color={0,0,0}),Text(
    ...
    model VoltageSensor "Multiphase voltage sensor"
      ...
      Modelica_Blocks.Interfaces.RealOutput v[m]
        ...
        annotation (Placement(transformation(
            ...
            extent={{10,-10},{-10,10}},
            rotation=90)));
      Modelica_Electrical_Analog.Sensors.VoltageSensor voltageSensor[m]
        annotation (Placement(transformation(extent={{-10,-10},{10,10}},
              rotation=0)));
    equation
      ...
      annotation (Icon(graphics={Text(
                  ...
                  lineColor={0,0,0},
                  textString="m="),Line(points={{-70,0},{-90,0}}, color={0,0,0}),
              Line(points={{70,0},{90,0}}, color={0,0,0}),Line(points={{0,-100},
      ...
      Modelica_Blocks.Interfaces.RealOutput i[m]
        "current in the branch from p to n as output signal" annotation (
          Placement(transformation(
            ...
            extent={{10,-10},{-10,10}},
            rotation=90)));
      Modelica_Electrical_Analog.Sensors.CurrentSensor currentSensor[m]
        annotation (Placement(transformation(extent={{-10,-10},{10,10}},
              rotation=0)));
    equation
...
<pre>
 I = sqrt(sum(i[k]^2 for k in 1:m)/m)
    ...
    model PowerSensor "Multiphase instantaneous power sensor"
      ...
      Modelica_Blocks.Math.Product product[m] annotation (Placement(
            transformation(
            origin={-30,-40},
            extent={{-10,-10},{10,10}},
            rotation=270)));
      Modelica_Blocks.Math.Sum sum(final nin=m, final k=ones(m)) annotation (
          Placement(transformation(
            origin={-30,-70},
            extent={{10,-10},{-10,10}},
            rotation=90)));
      ...
      Modelica_Blocks.Interfaces.RealInput v[m](each unit="V")
        "Voltage between pin p and n (= p.v - n.v) as input signal" annotation (
         Placement(transformation(
            ...
            extent={{-20,-20},{20,20}},
            rotation=270)));
      Modelica_Electrical_Analog.Sources.SignalVoltage signalVoltage[m]
        annotation (Placement(transformation(extent={{-10,-10},{10,10}},
              rotation=0)));
    equation
...
Contains m constant voltage sources (Modelica.Electrical.Analog.Sources.ConstantVoltage)
    ...
    model SineVoltage "Multiphase sine voltage source"
      ...
      parameter Modelica_SIunits.Angle phase[m]=-
          Functions.symmetricOrientation(                               m)
        "Phases of sine waves";
      parameter Modelica_SIunits.Frequency freqHz[m](start=fill(1, m))
        "Frequencies of sine waves";
      parameter Modelica_SIunits.Voltage offset[m]=zeros(m) "Voltage offsets";
      parameter Modelica_SIunits.Time startTime[m]=zeros(m) "Time offsets";
      Modelica_Electrical_Analog.Sources.SineVoltage sineVoltage[m](
        final V=V,
        final phase=phase,
        final freqHz=freqHz,
        final offset=offset,
...
<a href=\"modelica://Modelica.Electrical.MultiPhase.Functions.symmetricOrientation\">symmetricOrientation</a>.
    ...
    model CosineVoltage "Multiphase cosine voltage source"
      ...
      parameter Modelica_SIunits.Voltage offset[m]=zeros(m) "Voltage offsets";
      parameter Modelica_SIunits.Time startTime[m]=zeros(m) "Time offsets";
      Modelica_Electrical_Analog.Sources.CosineVoltage cosineVoltage[m](
        final V=V,
        final phase=phase,
        final freqHz=freqHz,
        final offset=offset,
      ...
      Modelica_Blocks.Interfaces.RealInput i[m](each unit="A")
        "Current flowing from pin p to pin n as input signal" annotation (
          Placement(transformation(
            ...
            extent={{-20,-20},{20,20}},
            rotation=270)));
      Modelica_Electrical_Analog.Sources.SignalCurrent signalCurrent[m]
        annotation (Placement(transformation(extent={{-10,-10},{10,10}},
              rotation=0)));
    equation
...
Contains m constant current sources (Modelica.Electrical.Analog.Sources.ConstantCurrent)
    ...
    model SineCurrent "Multiphase sine current source"
      ...
      parameter Modelica_SIunits.Frequency freqHz[m](start=fill(1, m))
        "Frequencies of sine waves";
      parameter Modelica_SIunits.Current offset[m]=zeros(m) "Current offsets";
      parameter Modelica_SIunits.Time startTime[m]=zeros(m) "Time offsets";
      Modelica_Electrical_Analog.Sources.SineCurrent sineCurrent[m](
        final I=I,
        final phase=phase,
        final freqHz=freqHz,
        final offset=offset,
...
<a href=\"modelica://Modelica.Electrical.MultiPhase.Functions.symmetricOrientation\">symmetricOrientation</a>.
    ...
    model CosineCurrent "Multiphase cosine current source"
      ...
      parameter Modelica_SIunits.Current offset[m]=zeros(m) "Current offsets";
      parameter Modelica_SIunits.Time startTime[m]=zeros(m) "Time offsets";
      Modelica_Electrical_Analog.Sources.CosineCurrent cosineCurrent[m](
        final I=I,
        final phase=phase,
        final freqHz=freqHz,
        final offset=offset,
