...
<blockquote><pre>
  ...
  Real direction[3](unit=\"1\") = to_unit1(v);   // Automatically vectorized call of to_unit1
    ...
    algorithm
      Kelvin := Celsius -Modelica_Constants.T_zero;
      annotation (Inline=true,Icon(coordinateSystem(preserveAspectRatio=true, extent={{-100,
                -100},{100,100}}), graphics={Text(
              extent={{-20,100},{-100,20}},
              lineColor={0,0,0},
    ...
    algorithm
      Fahrenheit := (Kelvin +Modelica_Constants.T_zero) *(9/5) + 32;
      annotation (Inline=true,Icon(coordinateSystem(preserveAspectRatio=true, extent={{-100,
                -100},{100,100}}), graphics={Text(
              extent={{-20,100},{-100,20}},
              lineColor={0,0,0},
    ...
    function from_degF "Convert from degFahrenheit to Kelvin"
      ...
      output Temperature Kelvin "Kelvin value";
    algorithm
      Kelvin := (Fahrenheit - 32)*(5/9) -Modelica_Constants.T_zero;
      annotation (Inline=true,Icon(coordinateSystem(preserveAspectRatio=true, extent={{-100,
                -100},{100,100}}), graphics={Text(
              extent={{-20,100},{-100,20}},
              lineColor={0,0,0},
    ...
    algorithm
      degree := (180.0/Modelica_Constants.pi)*radian;
      annotation (Inline=true,Icon(coordinateSystem(preserveAspectRatio=true, extent={{-100,
                -100},{100,100}}), graphics={Text(
    ...
    algorithm
      radian := (Modelica_Constants.pi/180.0)*degree;
      annotation (Inline=true,Icon(coordinateSystem(preserveAspectRatio=true, extent={{-100,
                -100},{100,100}}), graphics={Text(
              extent={{4,100},{-102,46}},
              lineColor={0,0,0},
    ...
    algorithm
      rpm := (30/Modelica_Constants.pi)*rs;
      annotation (Inline=true,Icon(coordinateSystem(preserveAspectRatio=true, extent={{-100,
                -100},{100,100}}), graphics={Text(
    ...
    algorithm
      rs := (Modelica_Constants.pi/30)*rpm;
      annotation (Inline=true,Icon(coordinateSystem(preserveAspectRatio=true, extent={{-100,
                -100},{100,100}}), graphics={Text(
...
<pre>
  ...
  type Temp_C = Conversions.NonSIunits.Temperature_degC;
 ...
 // Complex types for electrical systems (not defined in ISO 31-1992)
  ...
  operator record ComplexReluctance =
    Complex(redeclare Reluctance re,
             redeclare Reluctance im) "Complex reluctance"
    annotation (Documentation(info="<html>
<p>
