    ...
    model SignConvention "Examples for the used sign conventions."
      ...
      Components.Mass mass1(
        ...
        m=1) annotation (Placement(transformation(extent={{40,60},{60,80}},
              rotation=0)));
      Sources.Force force1 annotation (Placement(transformation(extent={{-4,60},
                {16,80}}, rotation=0)));
      ...
      Components.Mass mass2(
        ...
        m=1) annotation (Placement(transformation(extent={{40,0},{60,20}},
              rotation=0)));
      Sources.Force force2 annotation (Placement(transformation(extent={{-4,20},
                {16,40}}, rotation=0)));
      ...
      Components.Mass mass3(
        ...
        m=1) annotation (Placement(transformation(extent={{-40,-40},{-20,-20}},
              rotation=0)));
      Sources.Force force3(useSupport=true) annotation (Placement(
...
the two other examples).
    ...
    model InitialConditions "Setting of initial conditions"
      ...
      Components.Fixed fixed2(s0=1) annotation (Placement(transformation(extent=
               {{-100,60},{-80,80}}, rotation=0)));
      Components.Spring s2(s_rel0=2, c=1e3) annotation (Placement(
      ...
      Components.Fixed fixed1(s0=-1) annotation (Placement(transformation(
      ...
      Components.SpringDamper sd1(
        ...
        d=1) annotation (Placement(transformation(extent={{20,-20},{40,0}},
              rotation=0)));
      Components.Mass m2(L=2, m=1) annotation (Placement(transformation(extent=
...
<IMG src=\"modelica://Modelica/Resources/Images/Mechanics/Translational/InitialConditions.png\">
    ...
    model WhyArrows "Use of arrows in Mechanics.Translational"
      ...
      Components.Fixed fixed annotation (Placement(transformation(extent={{-20,
                20},{0,40}}, rotation=0)));
      Components.Rod rod1(L=1) annotation (Placement(transformation(extent={{-48,
                20},{-28,40}}, rotation=0)));
      Components.Rod rod2(L=1) annotation (Placement(transformation(extent={{20,
                20},{40,40}}, rotation=0)));
      Components.Rod rod3(L=1) annotation (Placement(transformation(extent={{-30,
                58},{-50,78}}, rotation=0)));
...
problems.
    ...
    model Accelerate "Use of model accelerate."
      ...
      extends Modelica_Icons.Example;
      Sources.Accelerate accelerate annotation (Placement(transformation(extent=
               {{-40,20},{-20,40}}, rotation=0)));
      Components.Mass mass(L=1, m=1) annotation (Placement(transformation(
    ...
    model Damper "Use of damper models."
      ...
      Components.Mass mass1(
        ...
        m=1) annotation (Placement(transformation(extent={{-80,60},{-60,80}},
              rotation=0)));
      Components.Damper damper1(d=25) annotation (Placement(transformation(
              extent={{-20,60},{0,80}}, rotation=0)));
      Components.Fixed fixed1(s0=4.5) annotation (Placement(transformation(
      ...
      Components.Mass mass2(
        ...
        m=1) annotation (Placement(transformation(extent={{-80,0},{-60,20}},
              rotation=0)));
      Components.Damper damper2(d=25) annotation (Placement(transformation(
              extent={{-20,0},{0,20}}, rotation=0)));
      Components.Fixed fixed2(s0=4.5) annotation (Placement(transformation(
      ...
      Components.Mass mass3(
        ...
        m=1) annotation (Placement(transformation(extent={{-80,-60},{-60,-40}},
              rotation=0)));
      Components.Fixed fixed3(s0=4.5) annotation (Placement(transformation(
              extent={{20,-60},{40,-40}}, rotation=0)));
      Components.Spring spring2(s_rel0=1, c=1) annotation (Placement(
            transformation(extent={{-20,-20},{0,0}}, rotation=0)));
      Components.SpringDamper springDamper3(
        s_rel0=1,
        d=25,
    ...
    model Oscillator "Oscillator demonstrates the use of initial conditions."
      ...
      Components.Mass mass1(
        ...
        m=1) annotation (Placement(transformation(extent={{-20,40},{0,60}},
              rotation=0)));
      Components.Spring spring1(s_rel0=1, c=10000) annotation (Placement(
            transformation(extent={{20,40},{40,60}}, rotation=0)));
      Components.Fixed fixed1(s0=1) annotation (Placement(transformation(extent=
               {{60,40},{80,60}}, rotation=0)));
      Sources.Force force1 annotation (Placement(transformation(extent={{-60,40},
                {-40,60}}, rotation=0)));
      ...
      Components.Mass mass2(
        ...
        m=1) annotation (Placement(transformation(extent={{-20,-60},{0,-40}},
              rotation=0)));
      Components.Spring spring2(s_rel0=1, c=10000) annotation (Placement(
            transformation(extent={{20,-60},{40,-40}}, rotation=0)));
      Components.Fixed fixed2(s0=1) annotation (Placement(transformation(extent=
               {{60,-60},{80,-40}}, rotation=0)));
      Sources.Force force2 annotation (Placement(transformation(extent={{-60,-60},
                {-40,-40}}, rotation=0)));
      Modelica_Blocks.Sources.Sine sine2(freqHz=15.9155) annotation (Placement(transformation(
              extent={{-100,-60},{-80,-40}}, rotation=0)));
      Components.Damper damper1(d=10) annotation (Placement(transformation(
    ...
    model Friction "Use of model Stop"
      ...
      Modelica_Mechanics_Translational.Components.MassWithStopAndFriction stop1(
        ...
        fexp=2) annotation (Placement(transformation(extent={{20,60},{40,80}},
              rotation=0)));
      Sources.Force force annotation (Placement(transformation(extent={{-20,60},
                {0,80}}, rotation=0)));
      ...
      Components.Spring spring(s_rel0=1, c=500) annotation (Placement(
            transformation(extent={{2,-60},{22,-40}}, rotation=0)));
      Components.Fixed fixed2(s0=-1.75) annotation (Placement(transformation(
              extent={{-40,-60},{-20,-40}}, rotation=0)));
      Sources.Force force2 annotation (Placement(transformation(extent={{-22,0},
                {-2,20}}, rotation=0)));
...
<li> Model stop2 gives an example for a hard stop. However there
    ...
    model PreLoad "Preload of a spool using ElastoGap models."
      ...
      Components.ElastoGap innerContactA(
        c=1000e3,
        d=250,
        s_rel0=0.001) annotation (Placement(transformation(extent={{-70,20},{-50,
                40}}, rotation=0)));
      Components.ElastoGap innerContactB(
        c=1000e3,
        d=250,
        s_rel0=0.001) annotation (Placement(transformation(extent={{50,20},{70,
                40}}, rotation=0)));
      Components.Mass spool(
        L=0.19,
        m=0.150,
        s(start=0.01475, fixed=true),
        v(fixed=true)) annotation (Placement(transformation(extent={{0,-40},{40,
                0}}, rotation=0)));
      Components.Fixed fixedLe(s0=-0.0955) annotation (Placement(transformation(
            extent={{-10,-10},{10,10}},
            rotation=270,
            origin={-80,90})));
      Components.Mass springPlateA(
        m=10e-3,
        L=0.002,
        s(start=-0.093, fixed=true),
        v(fixed=true)) annotation (Placement(transformation(extent={{-38,60},{-18,
                80}}, rotation=0)));
      Components.Mass springPlateB(
        m=10e-3,
        s(start=-0.06925, fixed=true),
        L=0.002,
        v(fixed=true)) annotation (Placement(transformation(extent={{20,60},{40,
                80}}, rotation=0)));
      Components.Spring spring(c=20e3, s_rel0=0.025) annotation (Placement(
            transformation(extent={{-10,60},{10,80}}, rotation=0)));
      Components.ElastoGap outerContactA(
        c=1000e3,
        d=250,
        s_rel0=0.0015) annotation (Placement(transformation(extent={{-70,60},{-50,
                80}}, rotation=0)));
      Components.ElastoGap outerContactB(
        c=1000e3,
        d=250,
        s_rel0=0.0015) annotation (Placement(transformation(extent={{50,60},{70,
                80}}, rotation=0)));
      Components.Rod rod1(L=0.007) annotation (Placement(transformation(extent=
                {{-40,30},{-20,50}}, rotation=0)));
      Components.Damper friction(d=2500) annotation (Placement(transformation(
            origin={-80,50},
            extent={{-10,-10},{10,10}},
            rotation=270)));
      Sources.Force force annotation (Placement(transformation(extent={{-38,-30},
                {-18,-10}}, rotation=0)));
      Components.Rod housing(L=0.0305) annotation (Placement(transformation(
              extent={{-10,80},{10,100}}, rotation=0)));
      Components.Rod rod3(L=0.00575) annotation (Placement(transformation(
              extent={{-40,-2},{-20,18}}, rotation=0)));
      Components.Rod rod4(L=0.00575) annotation (Placement(transformation(
              extent={{20,-2},{40,18}}, rotation=0)));
      Components.Rod rod2(L=0.007) annotation (Placement(transformation(extent=
...
<li> to fix a rigid element, such as a sliding mass, at a specific
    ...
    model Mass "Sliding mass with inertia"
      ...
      extends Interfaces.PartialRigid(L=0, s(start=0, stateSelect=stateSelect));
...
A negative force at flange flange_a moves the sliding mass to the negative direction.
    ...
    model Rod "Rod without inertia"
      extends Interfaces.PartialRigid;
...
a coupling of the sliding mass with the housing via a spring.
    ...
    model Damper "Linear 1D translational damper"
      extends Interfaces.PartialCompliantWithRelativeStates;
...
to describe a coupling of the sliding mass with the housing via a spring/damper.
    ...
    model ElastoGap "1D translational spring damper combination with gap"
      extends
        Modelica_Mechanics_Translational.Interfaces.PartialCompliantWithRelativeStates;
      parameter Modelica_SIunits.TranslationalSpringConstant c(final min=0,
          start=1) "Spring constant";
      parameter Modelica_SIunits.TranslationalDampingConstant d(final min=0,
          start=1) "Damping constant";
...
<img src=\"modelica://Modelica/Resources/Images/Mechanics/Translational/ElastoGap1.png\">
    ...
    model SupportFriction "Coulomb friction in support"
      ...
      extends
        Modelica_Mechanics_Translational.Interfaces.PartialElementaryTwoFlangesAndSupport2;
      extends
        Modelica_Thermal_HeatTransfer.Interfaces.PartialElementaryConditionalHeatPortWithoutT;
...
<p>Couples rotational and translational motion, like an ideal rolling wheel, specifying the wheel radius.</p>
    ...
    model InitializeFlange
      ...
      Modelica_Blocks.Interfaces.RealInput s_start(unit="m") if use_s_start
        "Initial position of flange"
        annotation (Placement(transformation(extent={{-140,40},{-100,80}},
              rotation=0)));
      Modelica_Blocks.Interfaces.RealInput v_start(unit="m/s") if use_v_start
        "Initial speed of flange"
        annotation (Placement(transformation(extent={{-140,-20},{-100,20}},
              rotation=0)));
      Modelica_Blocks.Interfaces.RealInput a_start(unit="m/s2") if use_a_start
...
provided via a signal bus.
    ...
    encapsulated partial model PartialFrictionWithStop
        ...
        import SI = Modelica_SIunits;
        import Modelica_Mechanics_Translational.Interfaces.PartialRigid;
...
This package contains basic components 1D mechanical translational drive trains.
  ...
  package Sensors "Sensors for 1-dim. translational mechanical quantities"
    ...
    model PositionSensor "Ideal sensor to measure the absolute position"
      ...
      Modelica_Blocks.Interfaces.RealOutput s(unit="m")
...
Modelica.Blocks library).
    ...
    model SpeedSensor "Ideal sensor to measure the absolute velocity"
      extends Interfaces.PartialAbsoluteSensor;
      Modelica_Blocks.Interfaces.RealOutput v(unit="m/s")
...
Modelica.Blocks library).
    ...
    model AccSensor "Ideal sensor to measure the absolute acceleration"
      ...
      Modelica_Blocks.Interfaces.RealOutput a(unit="m/s2")
...
Modelica.Blocks library).
    ...
    model RelPositionSensor "Ideal sensor to measure the relative position"
      ...
      Modelica_Blocks.Interfaces.RealOutput s_rel(unit="m")
...
Modelica.Blocks library).
    ...
    model RelSpeedSensor "Ideal sensor to measure the relative speed"
      ...
      Modelica_Blocks.Interfaces.RealOutput v_rel(unit="m/s")
...
<li><i>First Version from August 26, 1999 by P. Beater</i> </li>
    ...
    model RelAccSensor "Ideal sensor to measure the relative acceleration"
      ...
      Modelica_Blocks.Interfaces.RealOutput a_rel(unit="m/s2")
...
Modelica.Blocks library).
    ...
    model ForceSensor "Ideal sensor to measure the force between two flanges"
      extends Interfaces.PartialRelativeSensor;
      Modelica_Blocks.Interfaces.RealOutput f(unit="N")
...
Modelica.Blocks library.
  ...
  package Sources "Sources to drive 1D translational mechanical components"
    ...
    model Position
      ...
      extends
        Modelica_Mechanics_Translational.Interfaces.PartialElementaryOneFlangeAndSupport2
      ...
      Modelica_Blocks.Interfaces.RealInput s_ref(unit="m")
...
blocks of the block library Modelica.Blocks.Sources.
    ...
    model Speed "Forced movement of a flange according to a reference speed"
      ...
      Modelica_SIunits.Acceleration a
        "If exact=false, absolute acceleration of flange_b else dummy";
      Modelica_Blocks.Interfaces.RealInput v_ref(unit="m/s")
...
blocks of the block library Modelica.Blocks.Sources.
    ...
    model Accelerate
      ...
      Modelica_Blocks.Interfaces.RealInput a_ref(unit="m/s2")
...
blocks of the block library Modelica.Blocks.Sources.
    ...
    model Force
      ...
      extends
        Modelica_Mechanics_Translational.Interfaces.PartialElementaryOneFlangeAndSupport2;
      Modelica_Blocks.Interfaces.RealInput f(unit="N")
...
blocks of Modelica.Blocks.Source.
    ...
    model LinearSpeedDependentForce "Linear dependency of force versus speed"
      extends Modelica_Mechanics_Translational.Interfaces.PartialForce;
...
connector is not connected).
    ...
    partial model PartialElementaryRotationalToTranslational
      ...
      extends
        Modelica_Mechanics_Rotational.Interfaces.PartialElementaryRotationalToTranslational;
      annotation (Documentation(info="<html>
