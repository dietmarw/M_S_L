...
<li> Button <b>shut</b> is used to shutdown the process,
  ...
  package Utilities "Utility components for the examples"
    ...
    model valve
      ...
      Modelica_Blocks.Interfaces.BooleanInput valveControl
        annotation (Placement(transformation(
              ...
              extent={{-20,-20},{20,20}},
              rotation=90)));
      Modelica_StateGraph.Examples.Utilities.Inflow2 inflow1 annotation (
            Placement(transformation(
              origin={50,0},
              extent={{-50,-50},{50,50}},
              rotation=90)));
      Modelica_StateGraph.Examples.Utilities.Outflow2 outflow1 annotation (
            Placement(transformation(
              origin={-50,0},
              extent={{-50,-50},{50,50}},
              rotation=90)));
    ...
    model Tank
      ...
      Modelica_StateGraph.Examples.Utilities.Inflow1 inflow1 annotation (
            Placement(transformation(extent={{-55,60},{-45,70}}, rotation=0)));
      Modelica_StateGraph.Examples.Utilities.Outflow1 outflow1 annotation (
