...
package Examples
  ...
  model PID_Controller
    ...
    Modelica_Blocks.Continuous.LimPID PI(
        ...
        yMax=12,
        Ni=0.1,
        initType=Types.InitPID.SteadyState,
        limitsAtInit=false,
        controllerType=Types.SimpleController.PI,
    ...
    Modelica_Blocks.Sources.KinematicPTP kinematicPTP(
        ...
        qdd_max={1}) annotation (Placement(transformation(extent={{-92,20},{-72,
                40}}, rotation=0)));
    Modelica_Blocks.Continuous.Integrator integrator(initType=Types.Init.InitialState)
...
is forced back to its limit after a transient phase.
  ...
  model Filter "Demonstrates the Continuous.Filter block with various options"
    ...
    Modelica_Blocks.Continuous.Filter CriticalDamping(
        analogFilter=Types.AnalogFilter.CriticalDamping,
    ...
    Modelica_Blocks.Continuous.Filter Bessel(
        normalized=normalized,
        analogFilter=Types.AnalogFilter.Bessel,
        init=init,
        filterType=filterType,
        order=order,
        f_cut=f_cut,
    ...
    Modelica_Blocks.Continuous.Filter Butterworth(
        normalized=normalized,
        analogFilter=Types.AnalogFilter.Butterworth,
        init=init,
        filterType=filterType,
        order=order,
        f_cut=f_cut,
    ...
    Modelica_Blocks.Continuous.Filter ChebyshevI(
        normalized=normalized,
        analogFilter=Types.AnalogFilter.ChebyshevI,
        init=init,
        filterType=filterType,
        order=order,
        f_cut=f_cut,
...
<img src=\"modelica://Modelica/Resources/Images/Blocks/Filter1.png\"
  ...
  model FilterWithDifferentiation
    ...
    Modelica_Blocks.Continuous.Filter Bessel(
        f_cut=f_cut,
        filterType=Types.FilterType.LowPass,
        order=3,
        analogFilter=Types.AnalogFilter.Bessel)
...
<tr>
  ...
  model InverseModel "Demonstrates the construction of an inverse model"
    ...
    Continuous.FirstOrder firstOrder1(
      k=1,
      T=0.3,
      initType=Types.Init.SteadyState)
      annotation (Placement(transformation(extent={{20,20},{0,40}})));
    Sources.Sine sine(
      freqHz=2,
      offset=1,
...
to show how diagram animations can be constructed.
  ...
  model BusUsage "Demonstrates the usage of a signal bus"
    ...
    Modelica_Blocks.Examples.BusUsage_Utilities.Part part annotation (Placement(
