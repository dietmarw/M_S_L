within ;
package Modelica_Mechanics_Rotational
...
drive trains with frictional losses.
  ...
  package Examples "Demonstration examples of the components of this package"
    ...
    model First "First example: simple drive train"
      ...
      parameter Modelica_SIunits.Frequency freqHz=5
      ...
      Components.Fixed fixed annotation (Placement(transformation(extent={{38,-48},
                {54,-32}}, rotation=0)));
      Sources.Torque torque(useSupport=true) annotation (Placement(
            transformation(extent={{-68,-8},{-52,8}}, rotation=0)));
      Components.Inertia inertia1(J=Jmotor) annotation (Placement(
            transformation(extent={{-38,-8},{-22,8}}, rotation=0)));
      Components.IdealGear idealGear(ratio=ratio, useSupport=true) annotation (
          Placement(transformation(extent={{-8,-8},{8,8}}, rotation=0)));
      Components.Inertia inertia2(
        J=2,
        phi(fixed=true, start=0),
        w(fixed=true, start=0)) annotation (Placement(transformation(extent={{
                22,-8},{38,8}}, rotation=0)));
      Components.Spring spring(c=1.e4, phi_rel(fixed=true)) annotation (
          Placement(transformation(extent={{52,-8},{68,8}}, rotation=0)));
      Components.Inertia inertia3(J=Jload, w(fixed=true, start=0)) annotation (
          Placement(transformation(extent={{82,-8},{98,8}}, rotation=0)));
      Components.Damper damper(d=damping) annotation (Placement(transformation(
            origin={46,-22},
            extent={{-8,-8},{8,8}},
            rotation=270)));
...
<p>Simulate for 1 second and plot the following variables:<br>
   angular velocities of inertias inertia2 and 3: inertia2.w, inertia3.w</p>
    ...
    model FirstGrounded
      ...
      Components.Fixed fixed annotation (Placement(transformation(extent={{38,-48},
                {54,-32}}, rotation=0)));
      Sources.Torque torque(useSupport=false) annotation (Placement(
            transformation(extent={{-68,-8},{-52,8}}, rotation=0)));
      Components.Inertia inertia1(J=Jmotor) annotation (Placement(
            transformation(extent={{-38,-8},{-22,8}}, rotation=0)));
      Components.IdealGear idealGear(ratio=ratio, useSupport=false) annotation (
         Placement(transformation(extent={{-8,-8},{8,8}}, rotation=0)));
      Components.Inertia inertia2(
        J=2,
        phi(fixed=true, start=0),
...
<p>Simulate for 1 second and plot the following variables:<br>
   angular velocities of inertias inertia2 and 3: inertia2.w, inertia3.w</p>
    ...
    model Friction "Drive train with clutch and brake"
      ...
      output Modelica_SIunits.Torque tBrake=brake.tau
        "Friction torque of brake";
      ...
      Components.Inertia inertia3(
        ...
        w(start=100,
          ...
          displayUnit="rad/s")) annotation (Placement(transformation(extent={{-60,
                -10},{-40,10}}, rotation=0)));
      Components.Clutch clutch(fn_max=160) annotation (Placement(transformation(
      ...
      Components.SpringDamper spring(c=160, d=1) annotation (Placement(
      ...
      Components.Brake brake(fn_max=1600, useSupport=true) annotation (
      ...
      Components.Fixed fixed annotation (Placement(transformation(extent={{-10,
                -30},{10,-10}}, rotation=0)));
    equation
...
(inertia1.w, inertia2.w, inertia3.w).</p>
    ...
    model CoupledClutches "Drive train with 3 dynamically coupled clutches"
      ...
      Components.Clutch clutch1(peak=1.1, fn_max=20) annotation (Placement(
      ...
      Modelica_Blocks.Sources.Step step1(startTime=T2) annotation (Placement(
            ...
            extent={{-5,-5},{15,15}},
            rotation=270)));
      Components.Inertia J2(
        J=1,
        phi(fixed=true, start=0),
        w(fixed=true, start=0)) annotation (Placement(transformation(extent={{-10,
                -10},{10,10}}, rotation=0)));
      Components.Clutch clutch2(peak=1.1, fn_max=20) annotation (Placement(
            transformation(extent={{20,-10},{40,10}}, rotation=0)));
      Components.Inertia J3(
        J=1,
        phi(fixed=true, start=0),
        w(fixed=true, start=0)) annotation (Placement(transformation(extent={{
                50,-10},{70,10}}, rotation=0)));
      Components.Clutch clutch3(peak=1.1, fn_max=20) annotation (Placement(
            transformation(extent={{80,-10},{100,10}}, rotation=0)));
      Components.Inertia J4(
        J=1,
        phi(fixed=true, start=0),
        w(fixed=true, start=0)) annotation (Placement(transformation(extent={{
                110,-10},{130,10}}, rotation=0)));
      ...
      Modelica_Blocks.Sources.Step step2(startTime=T3) annotation (Placement(
            ...
            extent={{-5,-5},{15,15}},
            rotation=270)));
      Components.Fixed fixed annotation (Placement(transformation(extent={{-100,
                -30},{-80,-10}}, rotation=0)));
    equation
...
locked, forward sliding.</p>
    ...
    model LossyGearDemo1
      ...
      Components.LossyGear gear(
        ratio=2,
        lossTable=[0,0.5,0.5,0,0],
        useSupport=true) annotation (Placement(transformation(extent={{-10,0},{
                10,20}}, rotation=0)));
      Components.Inertia Inertia1(J=1) annotation (Placement(transformation(
      ...
      Sources.Torque torque1(useSupport=true) annotation (Placement(
            transformation(extent={{-70,0},{-50,20}}, rotation=0)));
      Sources.Torque torque2(useSupport=true) annotation (Placement(
            transformation(extent={{70,0},{50,20}}, rotation=0)));
...
gear.mode  :  1 = forward rolling
    ...
    model LossyGearDemo2
      ...
      Sources.Torque torque1(useSupport=true) annotation (Placement(
            transformation(extent={{-110,0},{-90,20}}, rotation=0)));
      Sources.Torque torque2(useSupport=true) annotation (Placement(
      ...
      Modelica_Blocks.Sources.Ramp load(
        ...
        offset=-10) annotation (Placement(transformation(extent={{90,0},{70,20}},
              rotation=0)));
      Components.BearingFriction bearingFriction(tau_pos=[0,0.5; 1,1],
          useSupport=true) annotation (Placement(transformation(extent={{-80,0},
                {-60,20}}, rotation=0)));
      Components.Fixed fixed annotation (Placement(transformation(extent={{-20,
                -30},{0,-10}}, rotation=0)));
    equation
      connect(torque2.flange, Inertia2.flange_b)
...
(no convergence of the event iteration).
    ...
    model ElasticBearing "Example to show possible usage of support flange"
      extends Modelica_Icons.Example;
      Components.Inertia shaft(
        phi(fixed=true, start=0),
        J=1,
        w(fixed=true, start=0)) annotation (Placement(transformation(extent={{-20,
                40},{0,60}}, rotation=0)));
      Components.Inertia load(J=50, w(fixed=true, start=0)) annotation (
          Placement(transformation(extent={{70,40},{90,60}}, rotation=0)));
      Components.Spring spring(c=1e3, phi_rel(fixed=true)) annotation (
          Placement(transformation(extent={{40,40},{60,60}}, rotation=0)));
      Components.Fixed fixed annotation (Placement(transformation(extent={{10,-70},
                {30,-50}}, rotation=0)));
      ...
      Components.IdealGear idealGear(ratio=3, useSupport=true) annotation (
          Placement(transformation(extent={{10,40},{30,60}}, rotation=0)));
      Components.Inertia housing(J=5) annotation (Placement(transformation(
            origin={20,22},
            extent={{-10,-10},{10,10}},
            rotation=90)));
...
(since the ElastoBacklash model takes care of it).
    ...
    model RollingWheel "Demonstrate coupling Rotational - Translational"
      extends Modelica_Icons.Example;
      Components.IdealRollingWheel idealRollingWheel(radius=1)
...
is present in variable convection.fluid.
    ...
    model SimpleGearShift "Simple Gearshift"
      extends Modelica_Icons.Example;
      output Modelica_SIunits.AngularVelocity wEngine=engine.w
        "Speed of engine";
...
<li> to fix a rigid element, such as an inertia, with a specific
    ...
    model Inertia "1D-rotational component with inertia"
      Interfaces.Flange_a flange_a "Left flange of shaft" annotation (Placement(
            transformation(extent={{-110,-10},{-90,10}}, rotation=0)));
      Interfaces.Flange_b flange_b "Right flange of shaft" annotation (
          Placement(transformation(extent={{90,-10},{110,10}}, rotation=0)));
      parameter Modelica_SIunits.Inertia J(min=0, start=1) "Moment of inertia";
      parameter StateSelect stateSelect=StateSelect.default
        "Priority to use phi and w as states"
        annotation (HideResult=true, Dialog(tab="Advanced"));
      Modelica_SIunits.Angle phi(stateSelect=stateSelect)
        "Absolute rotation angle of component"
        annotation (Dialog(group="Initialization", showStartAttribute=true));
      Modelica_SIunits.AngularVelocity w(stateSelect=stateSelect)
        "Absolute angular velocity of component (= der(phi))"
        annotation (Dialog(group="Initialization", showStartAttribute=true));
      Modelica_SIunits.AngularAcceleration a
...
Rotational component with <b>inertia</b> and two rigidly connected flanges.
    ...
    model Disc
      ...
      parameter Modelica_SIunits.Angle deltaPhi=0
        "Fixed rotation of left flange with respect to right flange (= flange_b.phi - flange_a.phi)";
      Modelica_SIunits.Angle phi "Absolute rotation angle of component";
...
flange.
    ...
    model Spring "Linear 1D rotational spring"
      extends Modelica_Mechanics_Rotational.Interfaces.PartialCompliant;
      parameter Modelica_SIunits.RotationalSpringConstant c(final min=0, start=
            1.0e5) "Spring constant";
      parameter Modelica_SIunits.Angle phi_rel0=0 "Unstretched spring angle";
...
a coupling of the element with the housing via a spring.
    ...
    model Damper "Linear 1D rotational damper"
      extends
        Modelica_Mechanics_Rotational.Interfaces.PartialCompliantWithRelativeStates;
      parameter Modelica_SIunits.RotationalDampingConstant d(final min=0, start=
           0) "Damping constant";
      extends
        Modelica_Thermal_HeatTransfer.Interfaces.PartialElementaryConditionalHeatPortWithoutT;
    equation
...
in the User's Guide of the Rotational library.
    ...
    model ElastoBacklash
      ...
      parameter Modelica_SIunits.RotationalSpringConstant c(final min=
            Modelica_Constants.small, start=1.0e5)
        "Spring constant (c > 0 required)";
      parameter Modelica_SIunits.RotationalDampingConstant d(final min=0, start=
           0) "Damping constant";
      parameter Modelica_SIunits.Angle b(final min=0) = 0 "Total backlash";
      parameter Modelica_SIunits.Angle phi_rel0=0 "Unstretched spring angle";
      ...
      extends
        Modelica_Thermal_HeatTransfer.Interfaces.PartialElementaryConditionalHeatPortWithoutT;
    protected
      final parameter Modelica_SIunits.Angle bMax=b/2
        "Backlash in range bMin <= phi_rel - phi_rel0 <= bMax";
      final parameter Modelica_SIunits.Angle bMin=-bMax
        "Backlash in range bMin <= phi_rel - phi_rel0 <= bMax";
      Modelica_SIunits.Torque tau_c;
      Modelica_SIunits.Torque tau_d;
      Modelica_SIunits.Angle phi_diff=phi_rel - phi_rel0;

      // A minimum backlash is defined in order to avoid an infinite
      // number of state events if backlash b is set to zero.
      constant Modelica_SIunits.Angle bEps=1e-10 "Minimum backlash";
...
in the User's Guide of the Rotational library.
    ...
    model BearingFriction "Coulomb friction in bearings"
      extends
        Modelica_Mechanics_Rotational.Interfaces.PartialElementaryTwoFlangesAndSupport2;
    ...
    equation
      ...
      tau0 = Modelica_Math.Vectors.interpolate(tau_pos[:,1], tau_pos[:,2], 0, 1);
      tau0_max = peak*tau0;
      free = false;
      ...
      tau = if locked then sa*unitTorque else (
        if startForward then
          Modelica_Math.Vectors.interpolate(tau_pos[:,1], tau_pos[:,2], w, 1)
...
<dd><b>A new model for control of systems with friction.</b>
    ...
    model Brake "Brake based on Coulomb friction"
      ...
      Modelica_SIunits.Angle phi
        "Angle between shaft flanges (flange_a, flange_b) and support";
      Modelica_SIunits.Torque tau "Brake friction torque";
      Modelica_SIunits.AngularVelocity w
        "Absolute angular velocity of flange_a and flange_b";
      Modelica_SIunits.AngularAcceleration a
        "Absolute angular acceleration of flange_a and flange_b";
      ...
      Modelica_Blocks.Interfaces.RealInput f_normalized
    ...
    equation
      ...
      tau = if locked then sa*unitTorque else if free then 0 else cgeo*fn*(
        if startForward then
          Modelica_Math.Vectors.interpolate(mue_pos[:,1], mue_pos[:,2], w, 1)
        else if startBackward then
          -Modelica_Math.Vectors.interpolate(mue_pos[:,1], mue_pos[:,2], -w, 1)
        else if pre(mode) == Forward then
          Modelica_Math.Vectors.interpolate(mue_pos[:,1], mue_pos[:,2], w, 1)
...
in the User's Guide of the Rotational library.
    ...
    model Clutch "Clutch based on Coulomb friction"
      extends Modelica_Mechanics_Rotational.Icons.Clutch;
      extends
        Modelica_Mechanics_Rotational.Interfaces.PartialCompliantWithRelativeStates;
      ...
      Real mue0 "Friction coefficient for w=0 and forward sliding";
      Modelica_SIunits.Force fn "Normal force (fn=fn_max*f_normalized)";
      Modelica_Blocks.Interfaces.RealInput f_normalized
    ...
    equation
      ...
      tau = if locked then sa*unitTorque else if free then 0 else cgeo*fn*(
        if startForward then
          Modelica_Math.Vectors.interpolate(mue_pos[:,1], mue_pos[:,2], w_rel, 1)
        else if startBackward then
          -Modelica_Math.Vectors.interpolate(mue_pos[:,1], mue_pos[:,2], w_rel, 1)
        else if pre(mode) == Forward then
          Modelica_Math.Vectors.interpolate(mue_pos[:,1], mue_pos[:,2], w_rel, 1)
...
in the User's Guide of the Rotational library.
    ...
    model OneWayClutch "Series connection of freewheel and clutch"
      ...
      parameter Modelica_SIunits.Force fn_max(final min=0, start=1)
        "Maximum normal force";
      parameter Modelica_SIunits.AngularVelocity w_small=1e10
      ...
      Modelica_SIunits.Force fn "Normal force (fn=fn_max*inPort.signal)";
    ...
    protected
      Modelica_SIunits.Torque tau0 "Friction torque for w=0 and sliding";
      ...
      Modelica_SIunits.Torque tau0_max_low "Lowest value for tau0_max";
...
connected to other elements in an appropriate way.
    ...
    model LossyGear
      ...
      Modelica_SIunits.AngularVelocity w_a
        "Angular velocity of flange_a with respect to support";
      Modelica_SIunits.AngularAcceleration a_a
      ...
      Modelica_SIunits.Torque tauLoss
        "Torque loss due to friction in the gear teeth and in the bearings";
      Modelica_SIunits.Torque tauLossMax "Torque loss for positive speed";
      Modelica_SIunits.Torque tauLossMin "Torque loss for negative speed";

      Modelica_SIunits.Torque tauLossMax_p "Torque loss for positive speed";
      Modelica_SIunits.Torque tauLossMin_m "Torque loss for negative speed";
      ...
      Modelica_SIunits.Torque tau_eta_p "tau_eta assuming positive omega";
      Modelica_SIunits.Torque tau_eta_m "tau_eta assuming negative omega";
    protected
      constant Modelica_SIunits.AngularAcceleration unitAngularAcceleration=1;
      constant Modelica_SIunits.Torque unitTorque=1;

      // get friction and eta information for omega=0
      parameter Real eta_mf1_0=Modelica_Math.Vectors.interpolate(lossTable[:,1], lossTable[:,2], 0, 1);
      parameter Real eta_mf2_0=Modelica_Math.Vectors.interpolate(lossTable[:,1], lossTable[:,3], 0, 1);
      parameter Real tau_bf1_0=abs(Modelica_Math.Vectors.interpolate(lossTable[:,1], lossTable[:,4], 0, 1));
      parameter Real tau_bf2_0=abs(Modelica_Math.Vectors.interpolate(lossTable[:,1], lossTable[:,5], 0, 1));
      parameter Real tau_bf_a_0=if Modelica_Math.isEqual(
              eta_mf1_0,
              1.0,Modelica_Constants.eps)
                                      and Modelica_Math.isEqual(
              eta_mf2_0,
              1.0,Modelica_Constants.eps)
                                      then tau_bf1_0/2 else (tau_bf1_0 -
    ...
    equation
      ...
      ideal = Modelica_Math.Matrices.isEqual(
            lossTable,
            [0, 1, 1, 0, 0],Modelica_Constants.eps);
      ...
      if ideal then
        ...
        interpolation_result = [
          Modelica_Math.Vectors.interpolate(lossTable[:,1], lossTable[:,2], noEvent(abs(w_a)), 1),
          Modelica_Math.Vectors.interpolate(lossTable[:,1], lossTable[:,3], noEvent(abs(w_a)), 1),
          Modelica_Math.Vectors.interpolate(lossTable[:,1], lossTable[:,4], noEvent(abs(w_a)), 1),
          Modelica_Math.Vectors.interpolate(lossTable[:,1], lossTable[:,5], noEvent(abs(w_a)), 1)];
      ...
      if Modelica_Math.isEqual(
              eta_mf1,
              1.0,Modelica_Constants.eps)
                                      and Modelica_Math.isEqual(
              eta_mf2,
              1.0,Modelica_Constants.eps) then
...
in the flanges, are along the axis vector displayed in the icon.
    ...
    model Gearbox "Realistic model of a gearbox (based on LossyGear)"
      extends Modelica_Mechanics_Rotational.Icons.Gearbox;
      extends
        Modelica_Mechanics_Rotational.Interfaces.PartialTwoFlangesAndSupport;
      ...
      Modelica_SIunits.AngularVelocity w_rel(
        start=0,
        stateSelect=stateSelect) = der(phi_rel)
        "Relative angular velocity over gear elasticity (= der(phi_rel))";
      Modelica_SIunits.AngularAcceleration a_rel(start=0) = der(w_rel)
...
Gearbox.
    ...
    model IdealGearR2T
      ...
      extends Interfaces.PartialElementaryRotationalToTranslational;
...
<pre>
  (flangeR.phi - internalSupportR.phi) = ratio*(flangeT.s - internalSupportT.s);
    ...
    model IdealRollingWheel
      ...
      extends Interfaces.PartialElementaryRotationalToTranslational;
      parameter Modelica_SIunits.Distance radius(start=0.3) "Wheel radius";
...
<pre>
   (flangeR.phi - internalSupportR.phi)*wheelRadius = (flangeT.s - internalSupportT.s);
    ...
    model InitializeFlange
      ...
      Modelica_Blocks.Interfaces.RealInput phi_start(unit="rad") if use_phi_start
        "Initial angle of flange" annotation (Placement(transformation(extent={
                {-140,60},{-100,100}}, rotation=0), iconTransformation(extent={
                {-140,60},{-100,100}})));
      Modelica_Blocks.Interfaces.RealInput w_start(unit="rad/s") if use_w_start
        "Initial speed of flange" annotation (Placement(transformation(extent={
                {-140,-20},{-100,20}}, rotation=0)));
      Modelica_Blocks.Interfaces.RealInput a_start(unit="rad/s2") if use_a_start
      ...
      Modelica_SIunits.Angle phi_flange(stateSelect=stateSelect) = flange.phi
        "Flange angle";
      Modelica_SIunits.AngularVelocity w_flange(stateSelect=stateSelect) = der(
    ...
    protected
      encapsulated model Set_phi_start "Set phi_start"
        ...
        M_S_L.Mechanics.Rotational.Interfaces.Flange_b flange annotation (
            Placement(transformation(extent={{90,-10},{110,10}}, rotation=0)));
      initial equation
      ...
      encapsulated model Set_a_start "Set a_start"
        ...
        M_S_L.Mechanics.Rotational.Interfaces.Flange_b flange(phi(stateSelect=
                StateSelect.avoid)) annotation (Placement(transformation(extent
                ={{90,-10},{110,10}}, rotation=0)));

        Modelica_SIunits.AngularVelocity w=der(flange.phi)
...
in the User's Guide of the Rotational library.
    ...
    model TorqueToAngleAdaptor
      ...
      Modelica_Blocks.Interfaces.RealOutput phi(unit="rad")
        ...
        annotation (Placement(transformation(extent={{20,70},{40,90}})));
      Modelica_Blocks.Interfaces.RealOutput w(unit="rad/s") if use_w
        "Flange moves with speed w due to torque tau"
        annotation (Placement(transformation(extent={{20,20},{40,40}})));
      Modelica_Blocks.Interfaces.RealOutput a(unit="rad/s2") if use_a
    ...
    protected
      Modelica_Blocks.Interfaces.RealInput w_internal
        "Needed to connect to conditional connector w";
      Modelica_Blocks.Interfaces.RealInput a_internal
...
This adaptor has torque as input and angle, angular velocity and angular acceleration as output signals.
    ...
    model AngleToTorqueAdaptor
      ...
      Modelica_Blocks.Interfaces.RealInput phi(unit="rad")
        "Angle to drive the flange" annotation (Placement(transformation(extent=
               {{-80,60},{-40,100}}), iconTransformation(extent={{-60,60},{-20,
                100}})));
      Modelica_Blocks.Interfaces.RealInput w(unit="rad/s") if use_w or use_a
      ...
      Modelica_Blocks.Interfaces.RealInput a(unit="rad/s2") if use_a
    ...
    protected
      Modelica_Mechanics_Rotational.Sources.Move move if use_a
        annotation (Placement(transformation(extent={{10,-10},{30,10}})));
      Modelica_Blocks.Routing.Multiplex3 multiplex3 if use_a
        annotation (Placement(transformation(extent={{-20,-10},{0,10}})));
      Modelica_Mechanics_Rotational.Sensors.TorqueSensor torqueSensor
        annotation (Placement(transformation(extent={{36,-10},{56,10}})));

      Modelica_Blocks.Routing.Multiplex2 multiplex2 if use_w and not use_a
        annotation (Placement(transformation(extent={{-20,40},{0,60}})));
      ...
      model Move_phi "Forced movement of a flange according to an angle signal"
        extends
          Modelica_Mechanics_Rotational.Interfaces.PartialElementaryOneFlangeAndSupport2;

        Modelica_Blocks.Interfaces.RealInput phi(
...
blocks of the block library Modelica.Blocks.Sources.
              ...
              extent={{-100,-100},{100,100}}), graphics={Text(
                      ...
                      lineColor={64,64,64},
                      fillPattern=FillPattern.HorizontalCylinder,
                      fillColor={192,192,192}),Line(points={{-30,-32},{30,-32}},
                color={0,0,0}),Line(points={{0,52},{0,32}}, color={0,0,0}),Line(
                points={{-29,32},{30,32}}, color={0,0,0}),Line(points={{0,-32},
                {0,-100}}, color={0,0,0}),Line(points={{30,-42},{20,-52}},
                color={0,0,0}),Line(points={{30,-32},{10,-52}}, color={0,0,0}),
                Line(points={{20,-32},{0,-52}}, color={0,0,0}),Line(points={{10,
                -32},{-10,-52}}, color={0,0,0}),Line(points={{0,-32},{-20,-52}},
                color={0,0,0}),Line(points={{-10,-32},{-30,-52}}, color={0,0,0}),
                Line(points={{-20,-32},{-30,-42}}, color={0,0,0}),Text(
...
This package contains basic components 1D mechanical rotational drive trains.
  ...
  package Sensors
    ...
    model AngleSensor "Ideal sensor to measure the absolute flange angle"
      ...
      Modelica_Blocks.Interfaces.RealOutput phi(unit="rad", displayUnit="deg")
...
(to be further processed with blocks of the Modelica.Blocks library).
    ...
    model AccSensor
      ...
      extends Interfaces.PartialAbsoluteSensor;
      Modelica_SIunits.AngularVelocity w "Absolute angular velocity of flange";
      Modelica_Blocks.Interfaces.RealOutput a(unit="rad/s2")
...
blocks of the Modelica.Blocks library).
    ...
    model RelAngleSensor
      ...
      Modelica_Blocks.Interfaces.RealOutput phi_rel(unit="rad", displayUnit="deg")
...
(to be further processed with blocks of the Modelica.Blocks library).
    ...
    model RelSpeedSensor
      ...
      Modelica_Blocks.Interfaces.RealOutput w_rel(unit="rad/s")
...
(to be further processed with blocks of the Modelica.Blocks library).
    ...
    model RelAccSensor
      ...
      Modelica_Blocks.Interfaces.RealOutput a_rel(unit="rad/s2")
...
(to be further processed with blocks of the Modelica.Blocks library).
    ...
    model MultiSensor
      ...
      extends .Modelica_Mechanics_Rotational.Interfaces.PartialRelativeSensor;
      Modelica_Blocks.Interfaces.RealOutput power(unit="W")
        "Power in flange flange_a as output signal"
        annotation (Placement(transformation(
            origin={-60,-110},
...
<p>Measures the <b>absolute angular velocity</b> of a flange_a, the <b>cut-torque</b> and <b>power</b> between two flanges in an ideal way and provides the results as output signals <b>w</b>, <b>tau</b> and <b>power</b>, respectively.
            ...
            Text(
              ...
              lineColor={0,0,0},
              textString="tau"),
            Line(points={{-60,-100},{-60,-60},{-94,-2}}, color={0,0,0}),
...
Modelica.Blocks library.
  ...
  package Sources "Sources to drive 1D rotational mechanical components"
    ...
    model Position
      ...
      Modelica_SIunits.Angle phi(stateSelect=if exact then StateSelect.default
             else StateSelect.prefer)
        "Rotation angle of flange with respect to support";
      Modelica_SIunits.AngularVelocity w(start=0, stateSelect=if exact then
      ...
      Modelica_Blocks.Interfaces.RealInput phi_ref(
        final quantity="Angle",
        final unit="rad",
        displayUnit="deg")
    ...
    protected
      parameter Modelica_SIunits.AngularFrequency w_crit=2*Modelica_Constants.pi
...
blocks of the block library Modelica.Blocks.Sources.
    ...
    model Speed
      ...
      Modelica_SIunits.Angle phi(
        ...
        "Rotation angle of flange with respect to support";
      Modelica_SIunits.AngularVelocity w(stateSelect=if exact then StateSelect.default
             else StateSelect.prefer)
        "Angular velocity of flange with respect to support";
      Modelica_SIunits.AngularAcceleration a
        "If exact=false, angular acceleration of flange with respect to support else dummy";
      Modelica_Blocks.Interfaces.RealInput w_ref(unit="rad/s")
...
blocks of the block library Modelica.Blocks.Sources.
    ...
    model Accelerate
      ...
      Modelica_Blocks.Interfaces.RealInput a_ref(unit="rad/s2")
...
blocks of the block library Modelica.Blocks.Sources.
    ...
    model Move
      ...
      Modelica_SIunits.Angle phi
        "Rotation angle of flange with respect to support";
      Modelica_Blocks.Interfaces.RealInput u[3]
...
blocks of Modelica.Blocks.Sources.
    ...
    model LinearSpeedDependentTorque "Linear dependency of torque versus speed"
      extends Modelica_Mechanics_Rotational.Interfaces.PartialTorque;
      parameter Modelica_SIunits.Torque tau_nominal
      ...
      parameter Modelica_SIunits.AngularVelocity w_nominal(min=
            Modelica_Constants.eps) "Nominal speed";
      Modelica_SIunits.AngularVelocity w
...
Parameter TorqueDirection chooses whether direction of torque is the same in both directions of rotation or not.
    ...
    equation
      ...
      if TorqueDirection then
        ...
        tau = tau_nominal*smooth(1, if w >= 0 then (w/w_nominal)^2 else -(w/
          w_nominal)^2);
      end if;
      annotation (
        Icon(
...
Parameter TorqueDirection chooses whether direction of torque is the same in both directions of rotation or not.
    ...
    model ConstantTorque "Constant torque, not dependent on speed"
      extends Interfaces.PartialTorque;
      parameter Modelica_SIunits.Torque tau_constant
...
Positive torque acts accelerating.
    ...
    model ConstantSpeed "Constant speed, not dependent on torque"
      ...
      Modelica_SIunits.AngularVelocity w
        "Angular velocity of flange with respect to support (= der(phi))";
      parameter Modelica_SIunits.AngularVelocity w_fixed "Fixed speed";
    equation
      w = der(phi);
      w = w_fixed;
      annotation (Icon(coordinateSystem(preserveAspectRatio=true, extent={{-100,-100},{
                100,100}}, initialScale=0.1), graphics={Line(points={{0,-100},{0,100}}, color={0,0,127}),
...
Model of <b>fixed</b> angular velocity of flange, not dependent on torque.
    ...
    model TorqueStep "Constant torque, not dependent on speed"
      extends Modelica_Mechanics_Rotational.Interfaces.PartialTorque;
      parameter Modelica_SIunits.Torque stepTorque(start=1)
        "Height of torque step (if negative, torque is acting as load)";
      parameter Modelica_SIunits.Torque offsetTorque(start=0)
        "Offset of torque";
    ...
    equation
      ...
      annotation (Icon(coordinateSystem(preserveAspectRatio=true, extent={{-100,-100},{
                100,100}}, initialScale=0.1), graphics={Line(points={{-80,-60},{0,-60},{0,60},{80,
...
<pre>
    ...
    connector Support "Support/housing of a 1-dim. rotational shaft"
      ...
      Modelica_SIunits.Angle phi
        "Absolute rotation angle of the support/housing";
...
and instead the component is internally fixed to ground.
    ...
    partial model PartialElementaryRotationalToTranslational
      ...
      Flange_a flangeR "Flange of rotational shaft" annotation (Placement(
            transformation(extent={{-110,-10},{-90,10}}, rotation=0)));
      Modelica_Mechanics_Translational.Interfaces.Flange_b flangeT
      ...
      Modelica_Mechanics_Translational.Interfaces.Support supportT if
                                                   useSupportT
    ...
    protected
      ...
      Modelica_Mechanics_Translational.Interfaces.InternalSupport
        internalSupportT(f=-flangeT.f)
        annotation (Placement(transformation(extent={{90,-90},{110,-70}})));
      Components.Fixed fixedR if not useSupportR
...
with the blocks of package Modelica.Blocks.
    ...
    partial model PartialFriction "Partial model of Coulomb friction elements"
      ...
      Modelica_SIunits.Torque tau0
        "Friction torque for w=0 and forward sliding";
      Modelica_SIunits.Torque tau0_max
        "Maximum friction torque for w=0 and locked";
      Boolean free "true, if frictional element is not active";
